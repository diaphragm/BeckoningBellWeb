if defined?(AssetSync)
  AssetSync.configure do |config|
    ...
    config.aws_access_key_id = Rails.application.credentials.aws[:s3][:key_id]
    config.aws_secret_access_key = Rails.application.credentials.aws[:s3][:access_key]
    ...
    config.fog_directory = 'beckoning-bell-web'
